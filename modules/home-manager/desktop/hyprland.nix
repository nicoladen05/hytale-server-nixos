  ...
  config = lib.mkIf config.home-manager.hyprland.enable {
    ...
    wayland.windowManager.hyprland.settings = {
      ...
      bind = [
        ...
        # Secondary modifiers
        "$secondaryMod, Return, exec, $terminal"
        "$secondaryMod, W, exec, $browser"
        "$secondaryMod, Q, killactive,"
        "$secondaryMod, M, exit,"
        "$secondaryMod, E, exec, $fileManager"
        "$secondaryMod SHIFT, Space, togglefloating,"
        "$secondaryMod, Space, exec, $menu"
        "$secondaryMod, P, pseudo, # dwindle"
        "$secondaryMod, J, togglesplit, # dwindle"

        # Move focus with mainMod + arrow keys
        "$secondaryMod, left, movefocus, l"
        "$secondaryMod, right, movefocus, r"
        "$secondaryMod, up, movefocus, u"
        "$secondaryMod, down, movefocus, d"

        "$secondaryMod, h, movefocus, l"
        "$secondaryMod, i, movefocus, r"
        "$secondaryMod, e, movefocus, u"
        "$secondaryMod, n, movefocus, d"

        # Swap window with mainMod + SHIFT + Arrow Keys
        "$secondaryMod SHIFT, left, movewindow, l"
        "$secondaryMod SHIFT, right, movewindow, r"
        "$secondaryMod SHIFT, up, movewindow, u"
        "$secondaryMod SHIFT, down, movewindow, d"

        "$secondaryMod SHIFT, h, movewindow, l"
        "$secondaryMod SHIFT, i, movewindow, r"
        "$secondaryMod SHIFT, e, movewindow, u"
        "$secondaryMod SHIFT, n, movewindow, d"

        # Swap window with mainMod + CONTROL + Arrow Keys
        "$secondaryMod CONTROL, left, resizeactive, -50 0"
        "$secondaryMod CONTROL, right, resizeactive, 50 0"
        "$secondaryMod CONTROL, up, resizeactive, 0 -50"
        "$secondaryMod CONTROL, down, resizeactive, 0 50"

        "$secondaryMod CONTROL, h, resizeactive, -50 0"
        "$secondaryMod CONTROL, i, resizeactive, 50 0"
        "$secondaryMod CONTROL, e, resizeactive, 0 -50"
        "$secondaryMod CONTROL, n, resizeactive, 0 50"
        ...
        "$secondaryMod, 6, workspace, 6"
        "$secondaryMod, 7, workspace, 7"
        "$secondaryMod, 8, workspace, 8"
        "$secondaryMod, 9, workspace, 9"
        "$secondaryMod, 0, workspace, 10"

        # Move active window to a workspace with mainMod + SHIFT + [0-9]
        "$secondaryMod SHIFT, 1, movetoworkspace, 1"
        "$secondaryMod SHIFT, 2, movetoworkspace, 2"
        "$secondaryMod SHIFT, 3, movetoworkspace, 3"
        "$secondaryMod SHIFT, 4, movetoworkspace, 4"
        "$secondaryMod SHIFT, 5, movetoworkspace, 5"
        "$secondaryMod SHIFT, 6, movetoworkspace, 6"
        "$secondaryMod SHIFT, 7, movetoworkspace, 7"
        "$secondaryMod SHIFT, 8, movetoworkspace, 8"
        "$secondaryMod SHIFT, 9, movetoworkspace, 9"
        "$secondaryMod SHIFT, 0, movetoworkspace, 10"

        # Fullscreen
        "$secondaryMod, F, fullscreen, 1"
        "$secondaryMod SHIFT, F, fullscreen"

        # Float
        "$secondaryMod, g, workspaceopt, allfloat"

        # Example special workspace (scratchpad)
        "$secondaryMod, S, togglespecialworkspace, magic"
        "$secondaryMod SHIFT, S, movetoworkspace, special:magic"

        # Show/hide bar
        "$secondaryMod, B, exec, pgrep waybar && pkill waybar || waybar &"

        # Screenshots
        "$secondaryMod, code:127, exec, hyprshot -m region"
        "$secondaryMod SHIFT, code:127, exec, hyprshot -m output -m active"
        "$secondaryMod CTRL, code:127, exec, hyprshot -m window -m active"

        "$secondaryMod, Escape, exec, rofi-power-menu"
